 ...
 * @return {String} Text data
 */
BeezConfBuilder.prototype.commander = function (theme, loglevel) {
    this.logger.level = loglevel || this.logger.LEVELS.WARN;
    colors.setTheme(theme || beezlib.constant.LOGGER_COLOR_THEME);
